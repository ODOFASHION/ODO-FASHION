...
if(nitaVisual){nitaVisual.innerHTML='<img class="odo-nita-img" src="WhatsApp%20Image%202026-08-15%20at%2017.38.43.jpeg" alt="Nita Kunwar">';}
...
document.addEventListener('submit',async e=>{
 ...
 localStorage.removeItem('odoCart');e.target.innerHTML=`<div class="order-success"><p class="eyebrow">ORDER CONFIRMED</p><h3>THANK YOU, ${esc(name.split(' ')[0]).toUpperCase()}.</h3><p>Order <strong>${orderNumber}</strong> is saved to your ODO account.</p><p class="cart-note">You can find this order anytime in MY ACCOUNT → ORDER HISTORY.</p><a class="checkout-submit" href="#streetwear">← BACK TO SHOP</a></div>`;
